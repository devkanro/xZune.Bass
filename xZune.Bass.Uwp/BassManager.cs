...
namespace xZune.Bass
{
    ...
    /// <returns>Pointer to the requested object.</returns>
            ...
            IntPtr windowHandle, Guid? dSoundGuid)
        {
            ...
            if (File.Exists(bassLibraryPath))
            {
                BassLibraryPath = bassLibraryPath;
                BassLibraryDirectory = Path.GetDirectoryName(bassLibraryPath);
            }
            ...
            else if (Directory.Exists(bassLibraryPath))
            {
                ...
                BassLibraryDirectory = bassLibraryPath;
                ...
                BassLibraryPath = files[0].FullName.Substring(rootDirectory.FullName.Length);
            }
