...
namespace xZune.Bass.Tag.Modules
{
    public class TagsLibCoreModule : TagsLibModule
    {
        ...
        internal static TagsLibFunction<SetTagEx> SetTagExFunction;
        internal static TagsLibFunction<AddTag> AddTagFunction;
        internal static TagsLibFunction<AddTagEx> AddTagExFunction;
        ...
        internal override void InitializeModule()
        {
            ...
            SetTagExFunction = new TagsLibFunction<SetTagEx>();
            AddTagFunction = new TagsLibFunction<AddTag>();
            AddTagExFunction = new TagsLibFunction<AddTagEx>();
        ...
        internal override void FreeModule()
        {
            ...
            SetTagFunction = null;
            SetTagExFunction = null;
            AddTagFunction = null;
            AddTagExFunction = null;
